...
export default function TextOverlayLayer({ containerRef }: TextOverlayLayerProps) {
  ...
  const handlePointerMove = (e: React.PointerEvent<HTMLDivElement>) => {
    ...
    useOverlaysStore.getState().updateOverlay(drag.overlayId, { x: newX, y: newY })
  }
  ...
  return (
    <div className="absolute inset-0 pointer-events-none" data-testid="text-overlay-layer">
